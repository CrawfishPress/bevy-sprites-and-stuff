...
pub fn do_add_sprites_action(mut commands: Commands,
    ...
    let texture_atlas1 = TextureAtlas::from_grid(texture_handle1, Vec2::new(128.0, 85.0), 1, 2);
    ...
    let texture_atlas2 = TextureAtlas::from_grid(texture_handle2, Vec2::new(256.0, 256.0), 1, 2);
